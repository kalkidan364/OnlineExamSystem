<template>
  <div class="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm">
    ...
    <div class="grid grid-cols-2 gap-2">
      <button class="flex flex-col items-center justify-center py-3 px-2 border border-slate-100 rounded-xl hover:border-[#5138ed] hover:shadow-sm transition-all group">
      ...
      <button class="flex flex-col items-center justify-center py-3 px-2 border border-slate-100 rounded-xl hover:border-[#5138ed] hover:shadow-sm transition-all group">
        ...
        <span class="text-[9px] xl:text-[10px] font-bold text-slate-600 group-hover:text-[#5138ed] text-center">Import Questions</span>
      </button>
      
      <button class="flex flex-col items-center justify-center py-3 px-2 border border-slate-100 rounded-xl hover:border-[#5138ed] hover:shadow-sm transition-all group">
        <svg class="w-4 h-4 text-[#5138ed] mb-1.5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
        <span class="text-[9px] xl:text-[10px] font-bold text-slate-600 group-hover:text-[#5138ed] text-center">Schedule Exam</span>
      </button>

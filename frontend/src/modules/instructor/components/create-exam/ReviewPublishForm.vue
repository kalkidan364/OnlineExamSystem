                        ...
                        <div>
                          ...
                          <div class="space-y-4">
                            <div v-for="(pair, cIdx) in (q.pairs || [])" :key="'l'+cIdx" class="flex gap-4">
                              ...
                              <div class="text-[13px] bg-slate-50 border border-slate-100 rounded-xl p-3 w-full flex-1 leading-relaxed text-slate-600" v-html="pair.left"></div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div class="space-y-4">
                            <div v-for="(pair, cIdx) in (q.pairs || [])" :key="'r'+cIdx" class="flex gap-4 items-center">
                              ...
                              <div class="text-[13px] flex-1 text-slate-600 leading-relaxed bg-white" v-html="pair.right"></div>
                            </div>
                          </div>
                        </div>
                      </div>

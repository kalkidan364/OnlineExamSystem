...
const stats = computed(() => {
  ...
  const sortedByCreated = [...banks].sort((a, b) => new Date((b as any).created_at || 0).getTime() - new Date((a as any).created_at || 0).getTime())
  ...
  return [
    ...
    {
      title: 'Last Created',
      value: formatDate((lastCreated as any)?.created_at),
